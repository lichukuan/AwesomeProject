...
var that;
export default class ServiceRecord extends React.Component {
    constructor(props){
      super(props);
  ...
  getDate(plus) {
    ...
    static renderMovie({item}) {
        ...
        console.log(item);
        let state = '';
        if(item.state == 'wait_deal'){
           state = '待处理'
        }else if(item.state == 'dealing'){
            state = '处理中'
        ...
        return (
            <View >
                <View style={{margin:5,backgroundColor:'white',padding:5}}>
                   ...
                   <View style={styles.item_container}>
                       <Text style={styles.item_left}>服务类型</Text>
                       <Text style={styles.item_right}>{item.tag}</Text>
                   </View>
                   <View style={styles.item_container}>
                   ...
                   <View style={styles.item_container}>
                       <Text style={styles.item_left}>创建时间</Text>
       ...
       return (
           <View>
              <FlatList
                ...
                renderItem={ServiceRecord.renderMovie}
